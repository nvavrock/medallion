...
- Publishing externally (internal learning audience only)
...
- Internal synthesis with survivorship and regulatory angles (per file review)

### Out of scope

- Proprietary data acquisition
- Public website/API
- [slack_problem.md](../slack_problem.md) (unrelated)
...
| M5 | Internal release v0.1.0 |

Time is not a primary constraint; depth and accuracy are.

## Stakeholders

- **Owner:** Internal researcher (personal learning)
- **Reviewers:** Self-review via claim audit and test plan gates

## Approval

This charter governs scope for internal release **v0.1.0**. Changes require an entry in CHANGELOG.md and, if scope-expanding, an update to requirements.md.
