# Signal → data crosswalk

**Last updated:** 2026-05-26

Maps each Phase III signal (`SIG-001` … `SIG-015` in [data/signals.yaml](../../data/signals.yaml)) to required [matrix](data_availability_matrix.yaml) rows, earliest plausible Medallion era, and blockers. Use before Phase VII experiments.
...
Tape consolidation [[claim:CLM-2027-002]] and L2 vendor eras [[claim:CLM-2027-003]] are the main **era gates** for microstructure signals. Alt-data rows require manifest paths before Phase VII download (see [data/manifest.yaml](../../data/manifest.yaml)).
